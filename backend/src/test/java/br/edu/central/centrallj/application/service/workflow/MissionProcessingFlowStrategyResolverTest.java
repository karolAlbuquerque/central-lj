package br.edu.central.centrallj.application.service.workflow;
...
class MissionProcessingFlowStrategyResolverTest {
  ...
  void prioridadeCriticaUsaFluxoCritico() {
    ...
    CriticalPriorityMissionProcessingFlowStrategy crit =
        new CriticalPriorityMissionProcessingFlowStrategy();
    MissionProcessingFlowStrategyResolver resolver =
        new MissionProcessingFlowStrategyResolver(def, crit);
