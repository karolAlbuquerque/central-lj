...
public class MissionController {
  ...
  public DashboardSummaryResponse dashboardSummary() {
    return getMissionUseCase.dashboardSummary();
  }
  ...
  public ResponseEntity<MissionResponse> create(@Valid @RequestBody CreateMissionRequest request) {
    return ResponseEntity.status(HttpStatus.CREATED).body(createMissionUseCase.create(request));
  }

  @GetMapping
  @PreAuthorize("hasAnyRole('ADMIN','OPERATOR')")
  public List<MissionResponse> list() {
    return getMissionUseCase.listAll();
  }

  @GetMapping("/recent")
  @PreAuthorize("hasAnyRole('ADMIN','OPERATOR')")
  public List<MissionResponse> recent() {
    return getMissionUseCase.recentMissions();
  }
  ...
  public List<MissionResponse> listByStatus(@PathVariable String status) {
    try {
      ...
      return getMissionUseCase.listByStatus(st);
  ...
  public List<MissionHistoryEntryResponse> getHistory(
    ...
    MissionDetailResponse detail = getMissionUseCase.getDetail(id);
    missionViewPolicy.assertCanView(principal, detail.missao());
    return getMissionUseCase.getHistory(id);
  }
  ...
  public MissionResponse assignHero(
    ...
    return assignMissionUseCase.assignHero(id, request);
  }
  ...
  public MissionResponse assignTeam(
    ...
    return assignMissionUseCase.assignTeam(id, request);
  }
}
