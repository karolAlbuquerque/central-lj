package br.edu.central.centrallj.adapter.out.realtime;
...
@Service
public class SseMissionNotificationAdapter implements MissionNotificationPort {

  private static final Logger log = LoggerFactory.getLogger(SseMissionNotificationAdapter.class);

  private final ObjectMapper objectMapper;
  private final CopyOnWriteArrayList<SseEmitter> emitters = new CopyOnWriteArrayList<>();

  public SseMissionNotificationAdapter(ObjectMapper objectMapper) {
