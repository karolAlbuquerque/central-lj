...
public class MissionEntity {
  ...
  private HeroiEntity heroiResponsavel;

  @ManyToOne(fetch = FetchType.LAZY)
  @JoinColumn(name = "equipe_responsavel_id")
  private EquipeHeroicaEntity equipeResponsavel;
  ...
  public HeroiEntity getHeroiResponsavel() {
    return heroiResponsavel;
  }

  public void setHeroiResponsavel(HeroiEntity heroiResponsavel) {
    this.heroiResponsavel = heroiResponsavel;
  }

  public EquipeHeroicaEntity getEquipeResponsavel() {
    return equipeResponsavel;
  }

  public void setEquipeResponsavel(EquipeHeroicaEntity equipeResponsavel) {
